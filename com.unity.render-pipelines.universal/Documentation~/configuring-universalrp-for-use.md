...
2. Right-click in the Project window, and select  __Create > Rendering > URP Pipeline Asset__. Alternatively, navigate to the menu bar in top, and click __Assets > Create > Rendering > Universal Render Pipeline > Pipeline Asset__.
