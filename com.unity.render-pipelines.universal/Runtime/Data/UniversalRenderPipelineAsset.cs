...
namespace UnityEngine.Rendering.Universal
{
    ...
    public partial class UniversalRenderPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        ...
        [MenuItem("Assets/Create/Rendering/URP Asset (with Forward Renderer)", priority = CoreUtils.Sections.k_Section2 + CoreUtils.Priorities.k_AssetsCreateRenderingMenuPriority)]
        ...
        //[MenuItem("Assets/Create/Rendering/URP Editor Resources", priority = CoreUtils.Sections.k_Section8 + CoreUtils.Priorities.k_AssetsCreateRenderingMenuPriority)]
