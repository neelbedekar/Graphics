...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    class HDRenderPipelineMenuItems
    {
        ...
        [MenuItem("Assets/Create/Rendering/HDRP Diffusion Profile", priority = CoreUtils.Sections.k_Section4 + CoreUtils.Priorities.k_AssetsCreateRenderingMenuPriority)]
        ...
        [MenuItem("Assets/Create/Rendering/HDRP C# Custom Pass", priority = CoreUtils.Sections.k_Section6 + CoreUtils.Priorities.k_AssetsCreateRenderingMenuPriority)]
        ...
        [MenuItem("Assets/Create/Rendering/HDRP C# Post Process Volume", priority = CoreUtils.Sections.k_Section6 + CoreUtils.Priorities.k_AssetsCreateRenderingMenuPriority)]
