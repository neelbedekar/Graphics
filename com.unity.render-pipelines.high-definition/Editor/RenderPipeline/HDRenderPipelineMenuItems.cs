...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    class HDRenderPipelineMenuItems
    {
        ...
        [MenuItem("Edit/Rendering/Export HDRP Sky to Image", priority = CoreUtils.Sections.k_Section2 + CoreUtils.Priorities.k_EditMenuPriority + 2)]
        ...
        [MenuItem("Edit/Rendering/Materials/Upgrade HDRP Materials to Latest Version", priority = CoreUtils.Priorities.k_EditMenuPriority)]
        ...
        [MenuItem("Edit/Rendering/Decal Layers/Add Decal Layer Default to Loaded Mesh Renderers and Terrains", priority = CoreUtils.Priorities.k_EditMenuPriority + 2)]
        ...
        [MenuItem("Edit/Rendering/Decal Layers/Add Decal Layer Default to Selected Mesh Renderers and Terrains", priority = CoreUtils.Priorities.k_EditMenuPriority + 1)]
        ...
        [MenuItem("Edit/Rendering/Check Scene Content for HDRP Ray Tracing", priority = CoreUtils.Sections.k_Section2 + CoreUtils.Priorities.k_EditMenuPriority + 3)]
        ...
        [MenuItem("Edit/Rendering/Fix Warning 'referenced script in (Game Object 'SceneIDMap') is missing' in loaded scenes", priority = CoreUtils.Sections.k_Section2 + CoreUtils.Priorities.k_EditMenuPriority + 4)]
