...
namespace UnityEditor.Rendering.HighDefinition
{
    class UpgradeStandardShaderMaterials
    {
        ...
        [MenuItem("Edit/Rendering/Materials/Convert All Built-in Materials to HDRP", priority = CoreUtils.Priorities.k_EditMenuPriority + 1)]
        ...
        [MenuItem("Edit/Rendering/Materials/Convert Selected Built-in Materials to HDRP", priority = CoreUtils.Priorities.k_EditMenuPriority + 2)]
        internal static void UpgradeMaterialsSelection()
        {
            MaterialUpgrader.UpgradeSelection(GetHDUpgraders(), "Upgrade to HDRP Material");
        }

        [MenuItem("Edit/Rendering/Materials/Convert Scene Terrains to HDRP Terrains", priority = CoreUtils.Priorities.k_EditMenuPriority + 2)]
